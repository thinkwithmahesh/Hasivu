...
const production_security_middleware_1 = require("../production-security.middleware");
...
describe('ProductionSecurityMiddleware - Security Tests', () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        mockSecurityService = new security_service_1.SecurityService();
        securityMiddleware = new production_security_middleware_1.ProductionSecurityMiddleware();
    ...
    describe('Rate Limiting Security', () => {
        it('should block requests exceeding rate limits', async () => {
            const request = new server_1.NextRequest('https://api.hasivu.edu.in/api/orders', {
                method: 'POST',
                headers: {
        ...
        it('should apply different rate limits for different endpoints', async () => {
            const authRequest = new server_1.NextRequest('https://api.hasivu.edu.in/api/auth/login', {
                method: 'POST',
                headers: { 'x-forwarded-for': '192.168.1.101' },
            });
            const orderRequest = new server_1.NextRequest('https://api.hasivu.edu.in/api/orders', {
                method: 'GET',
                headers: { 'x-forwarded-for': '192.168.1.101' },
            });
            const authResponses = [];
    ...
    describe('CSRF Protection Security', () => {
        ...
        it('should validate origin header against allowed origins', async () => {
            const maliciousRequest = new server_1.NextRequest('https://api.hasivu.edu.in/api/orders', {
                method: 'POST',
                headers: {
                    'content-type': 'application/json',
    ...
    describe('Input Sanitization Security', () => {
        it('should detect and block SQL injection attempts', async () => {
            ...
            const request = new server_1.NextRequest('https://api.hasivu.edu.in/api/users/search', {
                method: 'POST',
        ...
        it('should sanitize XSS attempts', async () => {
            ...
            const request = new server_1.NextRequest('https://api.hasivu.edu.in/api/menu/items', {
                method: 'POST',
                headers: { 'content-type': 'application/json' },
        ...
        it('should validate and sanitize file uploads', async () => {
            ...
            const request = new server_1.NextRequest('https://api.hasivu.edu.in/api/upload', {
                method: 'POST',
                body: formData,
            });
            const response = await securityMiddleware.handleRequest(request);
    ...
    describe('Bot Detection Security', () => {
        it('should detect and block obvious bots', async () => {
            const botRequest = new server_1.NextRequest('https://api.hasivu.edu.in/api/orders', {
                method: 'GET',
                headers: {
        ...
        it('should allow legitimate user agents', async () => {
            const legitimateRequest = new server_1.NextRequest('https://api.hasivu.edu.in/api/orders', {
                method: 'GET',
                headers: {
        ...
        it('should implement behavioral analysis for bot detection', async () => {
            ...
            const requests = Array.from({ length: 50 }, (_, i) => new server_1.NextRequest(`https://api.hasivu.edu.in/api/menu?page=${i}`, {
                method: 'GET',
                headers: {
            ...
            const responses = await Promise.all(requests.map(req => securityMiddleware.handleRequest(req)));
    ...
    describe('Security Headers', () => {
        it('should add all required security headers', async () => {
            const request = new server_1.NextRequest('https://api.hasivu.edu.in/api/health', {
                method: 'GET',
            });
            const response = await securityMiddleware.handleRequest(request);
        ...
        it('should set appropriate CORS headers for API endpoints', async () => {
            const request = new server_1.NextRequest('https://api.hasivu.edu.in/api/menu', {
                method: 'OPTIONS',
                headers: {
                    'origin': 'https://app.hasivu.edu.in',
    ...
    describe('Threat Tracking and Analytics', () => {
        ...
        it('should implement threat scoring and escalation', async () => {
            ...
            for (const attack of attacks) {
                const request = new server_1.NextRequest('https://api.hasivu.edu.in/api/test', {
                    method: 'POST',
                    headers: {
    ...
    describe('Performance Under Attack', () => {
        it('should maintain performance during DDoS simulation', async () => {
            ...
            const requests = Array.from({ length: 1000 }, (_, i) => new server_1.NextRequest('https://api.hasivu.edu.in/api/health', {
                method: 'GET',
        ...
        it('should not leak memory during sustained attacks', async () => {
            ...
            for (let minute = 0; minute < 10; minute++) {
                const requests = Array.from({ length: 100 }, (_, i) => new server_1.NextRequest('https://api.hasivu.edu.in/api/test', {
                    method: 'POST',
...
//# sourceMappingURL=production-security.middleware.security.test.js.map