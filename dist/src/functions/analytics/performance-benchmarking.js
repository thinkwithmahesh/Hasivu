...
exports.performanceBenchmarkingEngine = exports.PerformanceBenchmarkingEngine = exports.handler = exports.performanceBenchmarkingHandler = void 0;
const logger_service_1 = require("../shared/logger.service");
const database_service_1 = require("../shared/database.service");
const response_utils_1 = require("../shared/response.utils");
const lambda_auth_middleware_1 = require("../../shared/middleware/lambda-auth.middleware");
const zod_1 = require("zod");
const benchmarkQuerySchema = zod_1.z.object({
    benchmarkType: zod_1.z
        .enum(['industry', 'peer_group', 'competitive', 'best_practice'])
        .default('industry'),
    metrics: zod_1.z
        .array(zod_1.z.enum(['financial', 'operational', 'customer', 'growth', 'efficiency', 'quality']))
    ...
    anonymize: zod_1.z.boolean().default(true),
...
const competitiveAnalysisSchema = zod_1.z.object({
    ...
    includePublicData: zod_1.z.boolean().default(true),
    industrySegments: zod_1.z.array(zod_1.z.string()).optional(),
    geographicScope: zod_1.z.enum(['local', 'regional', 'national', 'global']).default('national'),
    timeHorizon: zod_1.z.enum(['current', '6_months', '12_months', '24_months']).default('current'),
});
class PerformanceBenchmarkingEngine {
    ...
    async generateIndustryBenchmark(metrics, timeframe, includeForecasts = false) {
        ...
        const filteredMetrics = benchmark.keyMetrics.filter(metric => metrics.length === 0 || metrics.includes(metric.category));
        const enhancedBenchmark = {
            ...benchmark,
    ...
    async generatePeerGroupAnalysis(schoolId, anonymize = true) {
        ...
        const revenue = targetSchool?.users
    ...
    generateAnonymizedMembers(count, anonymize) {
        const members = [];
    ...
    generateMemberCharacteristics(tier) {
        const characteristicsByTier = {
            top_quartile: [
    ...
    generateImprovementAreas(tier) {
        const improvementsByTier = {
        ...
        return [
            {
                ...
                category: 'Technology',
                description: 'Using machine learning to optimize menu planning based on nutritional requirements, cost, and student preferences',
                adoptionRate: 35,
                impactScore: 88,
            ...
            },
            {
                ...
                description: 'Comprehensive platform for meal planning, feedback, and communication with parents',
                adoptionRate: 68,
                impactScore: 76,
                implementationComplexity: 'medium',
                resourceRequirements: 'Mobile app development, Customer support training, 3-month implementation',
                successFactors: [
    ...
    async generateCompetitiveAnalysis(analysisType, geographicScope = 'national', includePublicData = true) {
    ...
    async generateCompetitorProfiles() {
        return [
            {
        ...
        return [
            {
                ...
                closingStrategy: 'Accelerated expansion through strategic partnerships and targeted acquisition',
    ...
    async generateBestPracticeRecommendations(category, implementationComplexity) {
        ...
        const recommendations = [
            {
                ...
                implementation: {
                    description: 'Implement machine learning algorithms to optimize meal planning based on nutritional requirements, cost constraints, and student preferences',
                    prerequisites: [
                    ...
                    contextualFactors: [
                        {
                            ...
                            importance: 'critical',
                            adaptationGuidance: 'Larger schools require more sophisticated models and integration',
                        },
                        {
                ...
                successStories: [
                    {
                        ...
                        resultsAchieved: '28% cost reduction, 35% improvement in nutrition scores, 92% parent satisfaction',
                        keyLearnings: [
                    ...
                    },
                    {
                        ...
                        resultsAchieved: '18% cost savings, 100% nutritional compliance, 15% reduction in food waste',
                        keyLearnings: [
...
exports.performanceBenchmarkingEngine = performanceBenchmarkingEngine;
const performanceBenchmarkingHandler = async (event, context) => {
    ...
    try {
        ...
        if (!authenticatedUser ||
            ...
            return (0, response_utils_1.createErrorResponse)('INSUFFICIENT_PERMISSIONS', 'Performance benchmarking requires analyst level permissions', 403);
        }
        ...
        return (0, response_utils_1.handleError)(error, 'Performance benchmarking operation failed');
    }
};
exports.performanceBenchmarkingHandler = performanceBenchmarkingHandler;
    ...
    switch (operation) {
        case 'industry-benchmark':
            try {
                ...
                const benchmark = await performanceBenchmarkingEngine.generateIndustryBenchmark(query.metrics, query.timeframe, query.includeForecasts);
                ...
                if (error instanceof zod_1.z.ZodError) {
                    return (0, response_utils_1.createErrorResponse)('VALIDATION_ERROR', 'Invalid benchmark parameters', 400);
                }
                throw error;
            }
        case 'peer-analysis':
            try {
                ...
                const peerAnalysis = await performanceBenchmarkingEngine.generatePeerGroupAnalysis(schoolId, anonymize);
                return (0, response_utils_1.createSuccessResponse)({
        ...
        case 'best-practices':
            try {
                ...
                const bestPractices = await performanceBenchmarkingEngine.generateBestPracticeRecommendations(category, complexity);
                return (0, response_utils_1.createSuccessResponse)({
    ...
    switch (operation) {
        case 'competitive-analysis':
            try {
                ...
                const competitiveAnalysis = await performanceBenchmarkingEngine.generateCompetitiveAnalysis(analysisRequest.analysisType, analysisRequest.geographicScope, analysisRequest.includePublicData);
                return (0, response_utils_1.createSuccessResponse)({
                ...
                if (error instanceof zod_1.z.ZodError) {
                    return (0, response_utils_1.createErrorResponse)('VALIDATION_ERROR', 'Invalid competitive analysis parameters', 400);
                }
                throw error;
            }
        default:
...
exports.handler = exports.performanceBenchmarkingHandler;
//# sourceMappingURL=performance-benchmarking.js.map