...
export declare class StructuredLoggingService {
    ...
    private assessPaymentRisk;
    private determineUserSegment;
    private calculateEngagementScore;
    private assessRetentionImpact;
    private triggerSecurityAlert;
    private sendToAuditStream;
    private sendToSecurityStream;
    private sendToPerformanceStream;
    private sendToBusinessStream;
    private sendToPaymentAuditStream;
    private sendToUserAnalyticsStream;
}
