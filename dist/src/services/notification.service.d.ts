...
export declare class NotificationService {
    ...
    private static getUserNotificationPreferences;
    private static getNotificationTemplate;
    private static getEnabledChannels;
    private static deliverNotification;
    private static sendEmailNotification;
    private static sendSMSNotification;
    private static sendWhatsAppNotification;
    private static sendSocketNotification;
