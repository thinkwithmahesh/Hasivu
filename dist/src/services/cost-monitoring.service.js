...
class CostMonitoringService {
    ...
    constructor() {
        this.costExplorer = new aws_sdk_1.CostExplorer({ region: 'us-east-1' });
        this.cloudwatch = new aws_sdk_1.CloudWatch({ region: process.env.AWS_REGION });
        this.budgets = new aws_sdk_1.Budgets({ region: 'us-east-1' });
        ...
        try {
            ...
            if (result.Budgets) {
                for (const budget of result.Budgets) {
                    ...
                    const forecastedSpend = actualSpend * 1.1;
...
//# sourceMappingURL=cost-monitoring.service.js.map