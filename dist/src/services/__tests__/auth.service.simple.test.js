...
describe('AuthService - Simple Tests', () => {
    ...
    describe('Error Handling', () => {
        it('should handle password hashing errors', async () => {
            jest.mocked(bcryptjs_1.default.hash).mockRejectedValueOnce(new Error('Hashing failed'));
        ...
        it('should handle password verification errors', async () => {
            jest.mocked(bcryptjs_1.default.compare).mockRejectedValueOnce(new Error('Compare failed'));
            const result = await authService.verifyPassword('password', 'hash');
...
//# sourceMappingURL=auth.service.simple.test.js.map