...
export type DataSourceType = 'postgresql' | 'mysql' | 'mongodb' | 'redis' | 'kafka' | 'kinesis' | 'rest_api' | 'file' | 's3' | 'bigquery' | 'snowflake';
...
export type DataSinkType = 'postgresql' | 'clickhouse' | 'bigquery' | 'snowflake' | 's3' | 'delta_lake' | 'elasticsearch' | 'kafka';
...
export type TransformationType = 'filter' | 'map' | 'aggregate' | 'join' | 'union' | 'sort' | 'deduplicate' | 'pivot' | 'window' | 'custom_sql' | 'custom_function';
...
//# sourceMappingURL=etl-types.d.ts.map