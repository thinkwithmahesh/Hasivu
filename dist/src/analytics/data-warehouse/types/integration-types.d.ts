...
export type IntegrationType = 'hasivu_system' | 'predictive_analytics' | 'business_intelligence' | 'performance_monitoring' | 'vendor_marketplace' | 'authentication' | 'kitchen_management';
