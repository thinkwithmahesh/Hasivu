export type StorageFormat = 'parquet' | 'delta' | 'orc' | 'avro' | 'json' | 'csv' | 'iceberg' | 'hudi' | 'arrow';
export type CompressionFormat = 'gzip' | 'snappy' | 'lz4' | 'zstd' | 'brotli' | 'lzo' | 'uncompressed';
export type PartitionScheme = 'time-based' | 'hash-based' | 'range-based' | 'list-based' | 'hybrid' | 'dynamic';
...
export type DataClassification = 'public' | 'internal' | 'confidential' | 'restricted' | 'sensitive' | 'pii';
...
//# sourceMappingURL=data-lake-types.d.ts.map