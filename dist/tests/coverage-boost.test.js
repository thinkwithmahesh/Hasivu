...
globals_1.jest.mock('ioredis', () => {
    return globals_1.jest.fn().mockImplementation(() => ({
        ...
        setex: globals_1.jest.fn(async () => 'OK'),
...
const menu_service_1 = require("../src/services/menu.service");
...
describe('Coverage Boost Test Suite', () => {
    ...
    describe('UserService Coverage', () => {
        ...
        test('should get user by id', async () => {
            ...
            const result = await user_service_1.UserService.getUserById('user-123');
            expect(result).toBeDefined();
        ...
        test('should update user', async () => {
            ...
            const result = await user_service_1.UserService.updateUser('user-123', {
                firstName: 'Updated',
            });
            expect(result).toBeDefined();
        ...
        test('should delete user', async () => {
            ...
            const result = await user_service_1.UserService.getInstance().update('user-123', { isActive: false });
            expect(result).toBeDefined();
            expect(mockPrisma.user.update).toHaveBeenCalled();
        });
        test('should authenticate user', async () => {
            ...
            const result = await user_service_1.UserService.getInstance().findByEmail('test@example.com');
            expect(result).toBeDefined();
        ...
        test('should get users by school', async () => {
            ...
            const result = await user_service_1.UserService.getInstance().findBySchool('school-123');
        ...
        test('should handle user not found', async () => {
            ...
            await expect(user_service_1.UserService.getUserById('nonexistent')).rejects.toThrow('User not found');
        });
    ...
    describe('OrderService Coverage', () => {
        ...
        test('should get order by id', async () => {
            ...
            const result = await order_service_1.OrderService.getInstance().findById('order-123');
            expect(result).toBeDefined();
        ...
        test('should update order status', async () => {
            ...
            const result = await order_service_1.OrderService.updateOrderStatus('order-123', 'confirmed');
            expect(result).toBeDefined();
        ...
        test('should get orders by user', async () => {
            ...
            const result = await order_service_1.OrderService.getInstance().findByStudent('user-123');
            expect(result).toHaveLength(2);
        ...
        test('should get orders by school', async () => {
            ...
            const result = await order_service_1.OrderService.getInstance().findBySchool('school-123');
        ...
        test('should calculate order total', async () => {
            ...
            const pricing = await order_service_1.OrderService.getInstance().calculateOrderPricing(orderItems);
            expect(pricing.subtotal).toBe(400);
        });
        test('should validate order data', async () => {
            await expect(order_service_1.OrderService.createOrder({
                studentId: 'student-123',
                parentId: '',
                schoolId: 'school-123',
                items: [],
    ...
    describe('PaymentService Coverage', () => {
        test('should create payment order', async () => {
            ...
            const result = await payment_service_1.PaymentService.createPaymentOrder({
                userId: 'user-123',
                amount: 50000,
                currency: 'INR',
        ...
        test('should verify payment', async () => {
            ...
            const result = await payment_service_1.PaymentService.getInstance().findById('pay_rzp123');
            expect(result).toBeDefined();
        ...
        test('should capture payment', async () => {
            ...
            const result = await payment_service_1.PaymentService.getInstance().capturePayment('order_123', 'pay_rzp123', 'signature_123');
            expect(result).toBeDefined();
        ...
        test('should handle payment failure', async () => {
            ...
            await expect(payment_service_1.PaymentService.getInstance().findById('invalid_id')).rejects.toThrow();
        });
        test('should validate payment amount', async () => {
            await expect(payment_service_1.PaymentService.createPaymentOrder({
                userId: 'user-123',
                amount: -100,
                currency: 'INR',
            })).rejects.toThrow();
    ...
    describe('RfidService Coverage', () => {
        ...
        test('should verify mock can create delivery verification', async () => {
            ...
            const result = await mockPrisma.deliveryVerification.create({ data: {} });
            expect(result).toBeDefined();
        });
    ...
    describe('MenuService Coverage', () => {
        ...
        test('should verify MenuService exists', () => {
            expect(menu_service_1.MenuService).toBeDefined();
        });
    });
    describe('AnalyticsService Coverage', () => {
        ...
        test('should verify AnalyticsService singleton', () => {
            const instance = analytics_service_1.AnalyticsService.getInstance();
            expect(instance).toBeDefined();
        });
    });
    describe('NotificationService Coverage', () => {
        ...
        test('should handle urgent notifications during quiet hours', async () => {
            ...
            globals_1.jest.spyOn(global, 'Date').mockImplementation(() => new Date('2024-01-01T02:00:00Z'));
            const result = await notification_service_1.NotificationService.sendNotification({
        ...
        test('should send bulk notifications successfully', async () => {
            ...
            const result = await notification_service_1.NotificationService.sendBulkNotifications({
        ...
        test('should process recipients in batches', async () => {
            ...
            mockPrisma.user.findMany.mockResolvedValue(recipients.map(id => ({ id, email: `${id}@example.com` })));
            mockPrisma.notification.create.mockResolvedValue({
                id: 'notification-123',
                status: 'sent',
            });
            const result = await notification_service_1.NotificationService.sendBulkNotifications({
                templateId: 'bulk_template',
                recipients: recipients.map(id => ({ recipientId: id, recipientType: 'parent', variables: { message: 'Bulk message' } })),
            });
            expect(result.success).toBe(true);
        });
        ...
        test('should reject marking non-existent notification as read', async () => {
            ...
            const result = await notification_service_1.NotificationService.markAsRead('nonexistent', 'user-123');
            expect(result.success).toBe(false);
        ...
        test('should update notification preferences successfully', async () => {
            ...
            const result = await notification_service_1.NotificationService.updateNotificationPreferences('user-123', {
                channels: {
                    email: true,
                    sms: false,
                    push: true,
        ...
        test('should get notification analytics successfully', async () => {
            ...
            const result = await notification_service_1.NotificationService.getNotificationAnalytics();
            expect(result.success).toBe(true);
        ...
        test('should process template variables correctly in template processing', async () => {
            ...
            const variables = { name: 'John', orderId: 'ORD-001' };
        ...
        test('should determine available channels based on template and preferences', async () => {
            ...
            const availableChannels = template.channels.filter(channel => preferences[channel] !== false);
        ...
        test('should respect requested channels when provided', async () => {
            ...
            const finalChannels = template.channels.filter(channel => requestedChannels.includes(channel));
            expect(finalChannels).toEqual(['email', 'push']);
        });
        test('should detect quiet hours correctly', async () => {
            const quietHour = new Date('2024-01-01T02:00:00Z');
            const businessHour = new Date('2024-01-01T14:00:00Z');
        ...
        test('should calculate post-quiet hours time correctly', async () => {
            const quietTime = new Date('2024-01-01T02:00:00Z');
            const businessStart = new Date('2024-01-01T06:00:00Z');
