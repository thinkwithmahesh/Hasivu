...
class OrderService {
    ...
    static CART_EXPIRY = 3600; // 1 hour
    static MAX_QUANTITY_PER_ITEM = 10;
    static ORDER_CUTOFF_HOURS = 2; // Hours before delivery
    ...
    static async processOrderPayment(input) {
        try {
            ...
            const paymentOrderData = {
                id: (0, uuid_1.v4)(),
                razorpayOrderId: `razorpay_${(0, uuid_1.v4)()}`, // Generate temporary ID - will be updated by payment gateway
                userId: order.userId,
                orderId: input.orderId,
