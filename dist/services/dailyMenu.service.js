...
class DailyMenuService {
    ...
    static async createDailyMenu(input) {
        try {
            ...
            // Note: Using school/date check since menuPlanId not available in CreateDailyMenuInput
    ...
    static async cloneDailyMenu(sourceId, targetDate, schoolId) {
        try {
          ...
          for this menu plan`);
            ...
            // Create cloned menu using repository clone method
    ...
    static async clearRelatedCaches(schoolId, date, category) {
        try {
            ...
            // Note: InMemoryCache.delete method not available, clear entire cache
            cache_1.cache.clear();
        }
        catch (error) {
