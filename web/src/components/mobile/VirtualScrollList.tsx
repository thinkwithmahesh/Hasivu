...
export function VirtualScrollList<T>({
  ...
  const visibleRange = useMemo((): VisibleRange => {
    ...
    const visibleEnd = Math.min(visibleStart + Math.ceil(containerHeight / itemHeight), itemCount);
...
export const useVirtualList = <T,>(items: T[], dependencies: React.DependencyList = []) => {
