  ...
  return (
    <Card className={className} aria-label="Forgot password form">
      ...
      <CardFooter className="flex flex-col space-y-2 text-center text-sm text-gray-600">
        <Link
          href="/auth/login"
          className="inline-flex items-center text-[var(--hasivu-primary)] hover:text-[var(--hasivu-primary)] font-medium focus:outline-none focus:underline"
        >
      ...
      <Card className={className} aria-label="Password reset success">
        ...
        <CardFooter className="flex flex-col space-y-2 text-center">
          <Link href="/auth/login">
            <Button className="w-full bg-[var(--hasivu-primary)] hover:bg-[var(--hasivu-primary-dark)] text-white">
              Continue to Sign In
            </Button>
          </Link>
        </CardFooter>
