            ...
            <TooltipContent>
              <div>
                ...
                <div className="text-xs mt-1">
                  Basmati rice, chicken, yogurt, onions, garlic, ginger, 
                  spices (cumin, coriander, turmeric, garam masala), 
                  mint leaves, saffron, ghee, salt
                </div>
              </div>
            </TooltipContent>
          </Tooltip>
  ...
  describe('Accessibility', () => {
      ...
      const { container } = render(
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent>
              Calories: 450, Protein: 28g, Carbs: 52g
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
      )
    ...
    it('supports screen reader announcements', async () => {
      ...
      render(
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger aria-label="Meal information button">
              ℹ️
            </TooltipTrigger>
            <TooltipContent>
