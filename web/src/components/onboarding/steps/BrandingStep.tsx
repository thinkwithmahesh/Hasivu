...
const BrandingStep: React.FC<BrandingStepProps> = ({ form, onNext, onPrev, isLoading = false }) => {
  ...
  const generateColorSuggestions = useCallback(() => {
    ...
    const suggestions = ['#3B82F6', '#10B981', '#8B5CF6', '#F97316', '#EF4444'];
        ...
        fontFamily:
          watchedValues.fontFamily === 'inter'
            ...
            : watchedValues.fontFamily === 'roboto'
              ? 'Roboto'
              : watchedValues.fontFamily === 'poppins'
                ? 'Poppins'
                : 'Noto Sans',
      }}
    >
      ...
      <div
        ...
        style={{
          backgroundColor: watchedValues.primaryColor + '10',
          borderColor: watchedValues.primaryColor,
        }}
      >
      ...
      {watchedValues.schoolMotto && (
        <div className="mt-4 pt-4 border-t border-gray-200 text-center">
          <p className="text-sm italic font-medium" style={{ color: watchedValues.secondaryColor }}>
            "{watchedValues.schoolMotto}"
          </p>
        </div>
      )}
    ...
    >
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Make HASIVU truly yours with custom branding that reflects your school's personality and
          values
        </p>
      </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
            <div className="flex items-center justify-between mb-6">
              ...
              >
                ...
                <span className="text-sm font-medium">{previewMode ? 'Exit' : 'Full'} Preview</span>
              </button>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="text-center">
                  <p className="text-gray-600 mb-4">
                    This is how your school's HASIVU portal will look to students, teachers, and
                    parents.
                  </p>
                  <button
                    onClick={() => {
