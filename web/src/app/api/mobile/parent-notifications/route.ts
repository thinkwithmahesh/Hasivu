...
const LAMBDA_MOBILE_PARENT_NOTIFICATIONS_URL = process.env.LAMBDA_MOBILE_PARENT_NOTIFICATIONS_URL;
...
export async function POST(request: NextRequest) {
  try {
    ...
    const lambdaResponse = await fetchConfiguredProxy(LAMBDA_MOBILE_PARENT_NOTIFICATIONS_URL, 'LAMBDA_MOBILE_PARENT_NOTIFICATIONS_URL', {
      method: 'POST',
      headers: {
