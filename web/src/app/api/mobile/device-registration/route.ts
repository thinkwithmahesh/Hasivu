...
const LAMBDA_MOBILE_DEVICE_REGISTRATION_URL =
  process.env.LAMBDA_MOBILE_DEVICE_REGISTRATION_URL ||
  'https://your-lambda-endpoint.execute-api.region.amazonaws.com/dev/mobile/device-registration';
