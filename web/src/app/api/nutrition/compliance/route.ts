...
const LAMBDA_COMPLIANCE_CHECKER_URL = process.env.LAMBDA_COMPLIANCE_CHECKER_URL;
...
export async function POST(request: NextRequest) {
  try {
    ...
    const lambdaResponse = await fetchConfiguredProxy(LAMBDA_COMPLIANCE_CHECKER_URL, 'LAMBDA_COMPLIANCE_CHECKER_URL', {
      method: 'POST',
      headers: {
