...
const LAMBDA_DIETARY_RECOMMENDATIONS_URL = process.env.LAMBDA_DIETARY_RECOMMENDATIONS_URL;
...
export async function POST(request: NextRequest) {
  try {
    ...
    const lambdaResponse = await fetchConfiguredProxy(LAMBDA_DIETARY_RECOMMENDATIONS_URL, 'LAMBDA_DIETARY_RECOMMENDATIONS_URL', {
      method: 'POST',
      headers: {
