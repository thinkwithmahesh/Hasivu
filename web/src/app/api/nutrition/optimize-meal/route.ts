...
const LAMBDA_MEAL_OPTIMIZATION_URL = process.env.LAMBDA_MEAL_OPTIMIZATION_URL;
...
export async function POST(request: NextRequest) {
  try {
    ...
    const lambdaResponse = await fetchConfiguredProxy(LAMBDA_MEAL_OPTIMIZATION_URL, 'LAMBDA_MEAL_OPTIMIZATION_URL', {
      method: 'POST',
      headers: {
