...
const LAMBDA_BUSINESS_INTELLIGENCE_URL = process.env.LAMBDA_BUSINESS_INTELLIGENCE_URL;
...
export async function POST(request: NextRequest) {
  try {
    ...
    const lambdaResponse = await fetchConfiguredProxy(LAMBDA_BUSINESS_INTELLIGENCE_URL, 'LAMBDA_BUSINESS_INTELLIGENCE_URL', {
      method: 'POST',
      headers: {
