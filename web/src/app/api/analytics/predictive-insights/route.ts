...
const LAMBDA_PREDICTIVE_INSIGHTS_URL = process.env.LAMBDA_PREDICTIVE_INSIGHTS_URL;
...
export async function POST(request: NextRequest) {
  try {
    ...
    const lambdaResponse = await fetchConfiguredProxy(LAMBDA_PREDICTIVE_INSIGHTS_URL, 'LAMBDA_PREDICTIVE_INSIGHTS_URL', {
      method: 'POST',
      headers: {
