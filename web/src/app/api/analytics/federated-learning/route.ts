...
const LAMBDA_FEDERATED_LEARNING_URL = process.env.LAMBDA_FEDERATED_LEARNING_URL;
...
export async function POST(request: NextRequest) {
  try {
    ...
    const lambdaResponse = await fetchConfiguredProxy(LAMBDA_FEDERATED_LEARNING_URL, 'LAMBDA_FEDERATED_LEARNING_URL', {
      method: 'POST',
      headers: {
