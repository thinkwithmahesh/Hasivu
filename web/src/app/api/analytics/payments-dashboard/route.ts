...
const _LAMBDA_PAYMENTS_DASHBOARD_URL =
  process.env.LAMBDA_PAYMENTS_DASHBOARD_URL ||
  'https://your-lambda-endpoint.execute-api.region.amazonaws.com/dev/analytics/payments-dashboard';
