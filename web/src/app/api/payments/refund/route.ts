...
const LAMBDA_PAYMENTS_REFUND_URL = process.env.LAMBDA_PAYMENTS_REFUND_URL;
...
export async function POST(request: NextRequest) {
  try {
    ...
    const lambdaResponse = await fetchConfiguredProxy(LAMBDA_PAYMENTS_REFUND_URL, 'LAMBDA_PAYMENTS_REFUND_URL', {
      method: 'POST',
      headers: {
