...
const LAMBDA_DIETARY_RECOMMENDATIONS_URL = process.env.LAMBDA_DIETARY_RECOMMENDATIONS_URL || "https://your-lambda-endpoint.execute-api.region.amazonaws.com/dev/nutrition/recommendations";
async function POST(request) {
    try {
        ...
        const lambdaResponse = await fetch(LAMBDA_DIETARY_RECOMMENDATIONS_URL, {
            method: "POST",
            headers: {
