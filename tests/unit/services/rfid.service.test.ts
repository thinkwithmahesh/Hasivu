...
describe('RFIDService', () => {
  ...
  describe('Card Registration', () => {
    describe('registerCard', () => {
      ...
      it('should register a new RFID card successfully', async () => {
        const result = await RFIDService.registerCard(validCardInput);
      ...
      it('should reject invalid card number format', async () => {
        ...
        const result = await RFIDService.registerCard(invalidInput);
  ...
  describe('Delivery Verification', () => {
    describe('verifyDelivery', () => {
      ...
      it('should verify delivery successfully with all validations', async () => {
        const result = await RFIDService.verifyDelivery(validVerificationInput);
      ...
      it('should verify delivery without order ID', async () => {
        ...
        const result = await RFIDService.verifyDelivery(inputWithoutOrder);
      ...
      it('should use cached reader data when available', async () => {
        ...
        await RFIDService.verifyDelivery(validVerificationInput);
      ...
      it('should handle verification cache management', async () => {
        ...
        // Check memory cache
        const verificationCache = (RFIDService as any).verificationCache;
  ...
  describe('Reader Management', () => {
    describe('updateReaderStatus', () => {
      ...
      it('should update reader status successfully', async () => {
        const result = await RFIDService.updateReaderStatus(statusUpdateInput);
      ...
      it('should update reader status without changing location', async () => {
        ...
        const result = await RFIDService.updateReaderStatus(inputWithoutLocation);
  ...
  describe('Verification History', () => {
    describe('getVerificationHistory', () => {
      ...
      it('should handle database errors gracefully', async () => {
        ...
        const result = await RFIDService.getVerificationHistory({});
  ...
  describe('Card Management', () => {
    describe('deactivateCard', () => {
      ...
      it('should deactivate card successfully', async () => {
        const result = await RFIDService.deactivateCard(cardId, reason);
    ...
    describe('bulkRegisterCards', () => {
      ...
      beforeEach(() => {
        ...
        const registerCardSpy = jest.spyOn(RFIDService, 'registerCard');
        registerCardSpy
      ...
      it('should process bulk registration with mixed results', async () => {
        const result = await RFIDService.bulkRegisterCards(bulkInput);
  ...
  describe('Analytics', () => {
    describe('getCardAnalytics', () => {
      ...
      it('should get card analytics successfully', async () => {
        const result = await RFIDService.getCardAnalytics(analyticsQuery);
      ...
      it('should filter analytics by school', async () => {
        await RFIDService.getCardAnalytics(analyticsQuery);
      ...
      it('should get analytics without school filter', async () => {
        ...
        await RFIDService.getCardAnalytics(queryWithoutSchool);
  ...
  describe('Cache Management', () => {
    ...
    it('should clear card cache on deactivation', async () => {
      ...
      await RFIDService.deactivateCard('card-id-123', 'Test reason');
    ...
    it('should clear reader cache on status update', async () => {
      ...
      await RFIDService.updateReaderStatus({ readerId: 'reader-123', status: 'offline' });
