/**
 * HASIVU Platform - RFID Verify Card Lambda Function Tests
 * Comprehensive test coverage for RFID card verification endpoint
 * Tests card validation, authorization, and verification logic
 * Generated by Epic 4: RFID Verification Test Coverage
 */
import { APIGatewayProxyEvent, Context } from 'aws-lambda';
import { handler as verifyRfidCardHandler } from '../../../../src/functions/rfid/verify-card';
...
describe('RFID Verify Card Lambda Function', () => {
  ...
  beforeEach(() => {
    ...
    (mockPrisma.rFIDCard.findUnique as jest.Mock).mockResolvedValue(mockRFIDCard);
    ...
    (mockPrisma.deliveryVerification.create as jest.Mock).mockResolvedValue(mockDeliveryVerification);
    (mockPrisma.rFIDCard.update as jest.Mock).mockResolvedValue({
      ...mockRFIDCard,
      lastUsedAt: new Date()
    });
  ...
  describe('Valid Card Verification', () => {
    it('should verify RFID card successfully with all components', async () => {
      const result = await verifyRfidCardHandler(validEvent, mockContext);
    ...
    it('should verify card without reader ID', async () => {
      ...
      await verifyRfidCardHandler(eventWithoutReader, mockContext);
    ...
    it('should verify card without order ID', async () => {
      ...
      await verifyRfidCardHandler(eventWithoutOrder, mockContext);
    ...
    it('should verify card with minimal data', async () => {
      ...
      await verifyRfidCardHandler(minimalEvent, mockContext);
  ...
  describe('Authentication and Authorization', () => {
    ...
    it('should allow super_admin to verify anywhere', async () => {
      ...
      await verifyRfidCardHandler(validEvent, mockContext);
  ...
  describe('Input Validation', () => {
    it('should reject missing request body', async () => {
      ...
      const result = await verifyRfidCardHandler(eventWithoutBody, mockContext);
    ...
    it('should reject invalid JSON body', async () => {
      ...
      const result = await verifyRfidCardHandler(eventWithInvalidJson, mockContext);
    ...
    it('should reject missing cardNumber', async () => {
      ...
      const result = await verifyRfidCardHandler(eventMissingCardNumber, mockContext);
    ...
    it('should reject invalid cardNumber format', async () => {
      const eventInvalidCardNumber = {
        ...validEvent,
        body: JSON.stringify({
          cardNumber: 'INVALID-FORMAT', // Doesn't match /^RFID-[A-Z0-9-]+$/
          readerId: 'reader-456'
        })
      };

      const result = await verifyRfidCardHandler(eventInvalidCardNumber, mockContext);
    ...
    it('should reject invalid readerId format', async () => {
      ...
      const result = await verifyRfidCardHandler(eventInvalidReaderId, mockContext);
    ...
    it('should reject invalid orderId format', async () => {
      ...
      const result = await verifyRfidCardHandler(eventInvalidOrderId, mockContext);
  ...
  describe('Database Error Handling', () => {
    it('should handle card lookup database errors', async () => {
      (mockPrisma.rFIDCard.findUnique as jest.Mock).mockRejectedValue(
    ...
    it('should handle verification creation database errors', async () => {
      (mockPrisma.deliveryVerification.create as jest.Mock).mockRejectedValue(
    ...
    it('should handle audit log creation failure gracefully', async () => {
      (mockPrisma.auditLog.create as jest.Mock).mockRejectedValue(
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle verification data with special characters', async () => {
      ...
      await verifyRfidCardHandler(specialCharEvent, mockContext);
    ...
    it('should handle very long location strings', async () => {
      ...
      await verifyRfidCardHandler(longLocationEvent, mockContext);
