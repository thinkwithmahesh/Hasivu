...
export type _DeliveryStatus = 'scheduled' | 'in_transit' | 'delivered' | 'failed' | 'returned';
...
export type _NotificationChannel = 'email' | 'sms' | 'push' | 'in_app';
...
export const _USER_ROLES = ['PARENT', 'STUDENT', 'TEACHER', 'ADMIN', 'SCHOOL_ADMIN'] as const;
export const _ORDER_STATUSES = [
  'draft',
  'confirmed',
  'preparing',
  'ready',
...
export const _PAYMENT_STATUSES = [
  'pending',
  'processing',
  'completed',
  'failed',
...
export const _DELIVERY_STATUSES = [
  'scheduled',
  'in_transit',
  'delivered',
  'failed',
...
export const _NOTIFICATION_CHANNELS = ['email', 'sms', 'push', 'in_app'] as const;
