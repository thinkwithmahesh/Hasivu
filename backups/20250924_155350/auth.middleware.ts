...
// import { createHash } from 'crypto'; // Commented out as unused
...
export const validateInput = (req: Request, res: Response, next: NextFunction): void => {
  try {
    ...
    // Recursively sanitize object - replaced 'any' with proper types for better type safety
...
/**
 * Session-based logout middleware
 */
...
export const extractSession = (
  ...
  req.sessionId = req.cookies?.sessionId || (req.headers['x-session-id'] as string);
  next();
};

/**
 * Combined authentication pipeline
 */
export const authPipeline = [extractSession, authMiddleware];
